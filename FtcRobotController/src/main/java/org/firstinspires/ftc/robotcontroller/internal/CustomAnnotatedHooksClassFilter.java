...
public class CustomAnnotatedHooksClassFilter implements ClassFilter {
    ...
    private static final Predicate<Method> isOnBotJava = method -> OnBotJavaDeterminer.isOnBotJava(method.getDeclaringClass());
    private static final Predicate<Method> isExternalLibraries = method -> OnBotJavaDeterminer.isExternalLibraries(method.getDeclaringClass());
    ...
    private static class InstanceHolder {
        public static CustomAnnotatedHooksClassFilter theInstance = new CustomAnnotatedHooksClassFilter();
    }
