...
public class VL53L1X_Constants {
  ...
  static final byte[] VL51L1X_DEFAULT_CONFIGURATION = {
    ...
    0x01, /* 0x30 : set bit 4 to 0 for active high interrupt and 1 for active low (bits 3:0 must be 0x1), use SetInterruptPolarity() */ // FR got no idea how this works. Used to be 0x1
