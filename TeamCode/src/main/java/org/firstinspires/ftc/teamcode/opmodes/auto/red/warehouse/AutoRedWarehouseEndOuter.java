...
@Autonomous(name = "CB_AUTO_RedWOuter")
@SuppressWarnings("unused")
public class AutoRedWarehouseEndOuter extends EnhancedAutonomous {
  ...
  private static final double RIGHT_DISTANCE_FROM_WALL_0 = 50.8;
  private final TurretBot robot;

  public AutoRedWarehouseEndOuter() {
  ...
  private void retreat(double preMoveFrontDistance) {
    ...
    while (opModeIsActive()
        && InterpolatablePipe.getInstance().currentDataPointOf(robot.rightRange.getName())
            >= RIGHT_DISTANCE_FROM_WALL_0) {
      processChanges();
    }
