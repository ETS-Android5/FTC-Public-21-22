  ...
  public IntakeState getState() {
    if (intakeServoState.getPosition() == LOWERED_POSITION) {
      return intakeMotorState.getPower() == INTAKING_SPEED
          ? IntakeState.LOWERED_AND_INTAKING
          : intakeMotorState.getPower() == OUTTAKING_SPEED
              ? IntakeState.LOWERED_AND_OUTTAKING
              : IntakeState.LOWERED_AND_STOPPED;
    } else {
      return intakeMotorState.getPower() == INTAKING_SPEED
          ? IntakeState.RAISED_AND_INTAKING
          : intakeMotorState.getPower() == OUTTAKING_SPEED
              ? IntakeState.RAISED_AND_OUTTAKING
              : IntakeState.RAISED_AND_STOPPED;
    }
  }
}
